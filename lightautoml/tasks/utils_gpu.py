...
def infer_gib_gpu(metric: Callable) -> bool:
    """Infer greater is better from metric for single GPU.
...
def infer_gib_mgpu(metric: Callable) -> bool:
    """Infer greater is better from metric for multi-GPU.
...
def infer_gib_multiclass_mgpu(metric: Callable) -> bool:
    """Infer greater is better from metric for multi-GPU.
