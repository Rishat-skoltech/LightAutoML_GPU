...
def mean_quantile_error(y_true: cp.ndarray, y_pred: cp.ndarray, sample_weight: Optional[cp.ndarray] = None,
                        q: float = 0.9) -> float:
...
@record_history(enabled=False)
def mean_huber_error(y_true: cp.ndarray, y_pred: cp.ndarray, sample_weight: Optional[cp.ndarray] = None,
                     a: float = 0.9) -> float:
...
@record_history(enabled=False)
def mean_fair_error(y_true: cp.ndarray, y_pred: cp.ndarray, sample_weight: Optional[cp.ndarray] = None,
                    c: float = 0.9) -> float:
...
@record_history(enabled=False)
def mean_absolute_percentage_error(y_true: cp.ndarray, y_pred: cp.ndarray,
...
@record_history(enabled=False)
def roc_auc_ovr(y_true: cp.ndarray, y_pred: cp.ndarray, sample_weight: Optional[cp.ndarray] = None):
...
@record_history(enabled=False)
def rmsle(y_true: cp.ndarray, y_pred: cp.ndarray, sample_weight: Optional[cp.ndarray] = None):
    ...
    """
    return cp.sqrt(mean_squared_log_error(y_true, y_pred, sample_weight=sample_weight))


@record_history(enabled=False)
def auc_mu(y_true: cp.ndarray, y_pred: cp.ndarray,
