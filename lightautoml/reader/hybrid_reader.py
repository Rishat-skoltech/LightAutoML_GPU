...
class HybridReader(CudfReader):
    ...
    def __init__(self, task: Task, num_cpu_readers: int, num_gpu_readers: int,
                 output: str, gpu_ratio: int, advanced_roles: bool = True,
    ...
    def fit_read(self, train_data,
        ...
        if num_readers > 1:
            ...
            output_roles.append(call_reader(readers[0], train_data[names[0]], target=train_data[self.target]))
        ...
        print(perf_counter() - st, "hybrid reader fit_read finished", output.shape)
