...
def test_pipeline():
    ...
    logging.info('OOF score: {}'.format(log_loss(train_cudf[TARGET_NAME].values.get(), oof_pred.data.get())))
    logging.info('TEST score: {}'.format(log_loss(test_cudf[TARGET_NAME].values.get(), test_pred.data.get())))
